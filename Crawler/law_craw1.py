...
os.chdir(r'D:\pysource\project\law_txts')
...
class Craw():
  ...
  def search_one_day(self, date):
    ...
    element = self.driver.find_element(By.ID, "jud_kw")
    actions = ActionChains(self.driver)
    actions.double_click(element).perform()
    self.driver.find_element(By.ID, "jud_kw").send_keys("傷害罪")#搜尋
...
if __name__ == '__main__':
	...
	today = date.today()
	#起始日期
	start_day = datetime.strptime('2015 11 25','%Y %m %d')
	#尋找次數
	days = 37
	#結束日期
	end_day = datetime.strptime('2015 12 31','%Y %m %d')
	#
	reverse = True
